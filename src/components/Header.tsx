            ...
            <div className="container flex justify-between items-center py-1 px-4 mx-auto">
                ...
                <nav className={isOpen ? "w-full" : " "}>
                    <ul className="gap-4 hidden md:flex py-4">
                        <Link href="/" className="cursor-pointer hover:text-button-hover active:text-button-active"><FaHome size={20} /></Link>
                        <Link href="/login" className="cursor-pointer hover:text-button-hover active:text-button-active"><FaUserCircle size={20} className="mx-auto" /></Link>
                        <button onClick={() => setToggleCart(!toggleCart)} className="relative cursor-pointer hover:text-button-hover active:text-button-active">
            ...
            <div className="md:hidden w-full bg-surface shadow text-primary fixed bottom-0 left-0 z-2">
                <div className="h-full  px-10">
                    <ul className="flex  justify-between items-center align-middle text-[12px]">
                        ...
                        <Link href="/" className=" hover:text-button-hover active:bg-button-active flex-col align-middle justify-center ">
                         <FaHome size={20} className="mx-auto" />
                         <span >Home</span> 
                        </Link></li>
                        <li className="p-1.5 flex align-middle mx-auto ">
