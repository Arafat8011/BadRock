    ...
    <div className="bg-color-card-bg text-color-primary rounded-sm shadow shadow-color-card-shadow overflow-hidden transition hover:scale-105">
      ...
      <div className="p-4">
        ...
        <div className="flex gap-2 mt-2">
          ...
          <Link href={`/products/item/${product.id}`} className="w-full py-2 rounded border border-color-primary text-center  text-color-primary  cursor-pointer hover:text-color-primary-fg  hover:bg-color-button-hover  active:bg-color-button-active  transition">
            View Details
          </Link>
        </div>
      </div>
